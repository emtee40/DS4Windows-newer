...
namespace DS4Windows
{
    public class DS4LightBar
    {
        ...
        static double[] counters = new double[Global.DS4_CONTROLLER_COUNT] { 0, 0, 0, 0, 0, 0, 0, 0 };
        public static Stopwatch[] fadewatches = new Stopwatch[Global.DS4_CONTROLLER_COUNT]
            { new Stopwatch(), new Stopwatch(), new Stopwatch(), new Stopwatch(),new Stopwatch(), new Stopwatch(), new Stopwatch(), new Stopwatch() };

        static bool[] fadedirection = new bool[Global.DS4_CONTROLLER_COUNT] { false, false, false, false, false, false, false, false };
        static DateTime[] oldnow = new DateTime[Global.DS4_CONTROLLER_COUNT]
            { DateTime.UtcNow, DateTime.UtcNow, DateTime.UtcNow, DateTime.UtcNow,DateTime.UtcNow, DateTime.UtcNow, DateTime.UtcNow, DateTime.UtcNow };

        public static bool[] forcelight = new bool[Global.DS4_CONTROLLER_COUNT] { false, false, false, false, false, false, false, false };
        public static DS4Color[] forcedColor = new DS4Color[Global.DS4_CONTROLLER_COUNT];
        public static byte[] forcedFlash = new byte[Global.DS4_CONTROLLER_COUNT];
