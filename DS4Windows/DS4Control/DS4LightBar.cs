...
namespace DS4Windows
{
    public class DS4LightBar
    {
        ...
        static double[] counters = new double[DS4_CONTROLLER_COUNT];
        public static Stopwatch[] fadewatches = InitControllerArrayFunc(DS4_CONTROLLER_COUNT, () => { return new Stopwatch(); });

        static bool[] fadedirection = new bool[DS4_CONTROLLER_COUNT];
        static DateTime[] oldnow = InitControllerArray(DS4_CONTROLLER_COUNT, DateTime.UtcNow);

        public static bool[] forcelight = new bool[DS4_CONTROLLER_COUNT];
        public static DS4Color[] forcedColor = new DS4Color[DS4_CONTROLLER_COUNT];
        public static byte[] forcedFlash = new byte[DS4_CONTROLLER_COUNT];
